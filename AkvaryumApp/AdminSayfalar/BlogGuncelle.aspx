<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="BlogGuncelle.aspx.cs" Inherits="AkvaryumApp.AdminSayfalar.BlogGüncelle" %>
            ...
            <div class="main-w3l">
                ...
                <div class="w3layouts-main">
                    ...
                    <form action="#" method="post" runat="server">
                        ...
                        <br />
                        <asp:DropDownList ID="DropDownList1" runat="server" DataTextField="TURAD" DataValueField="TURID" Height="18px" Width="179px"></asp:DropDownList>
                        <br />
                        <br />
                        <asp:DropDownList ID="DropDownList2" runat="server" DataTextField="KATEGORIAD" DataValueField="KATEGORIID" Height="17px" Width="180px"></asp:DropDownList>
                        <br />
                        <br />
