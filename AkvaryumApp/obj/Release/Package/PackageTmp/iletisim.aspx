...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="contact-content">
	 <div class="container">
			 ...
			 <form runat ="server">
                 <asp:TextBox ID="TextBox1" runat="server" placeholder="Ad ve Soyad: " required=""></asp:TextBox>
