<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Denemeee.aspx.cs" Inherits="AkvaryumApp.Denemeee" %>
...
<head>
  ...
  <title>Parason Software - Home</title>
	<link rel="icon" href="web3/img/Fevicon.png" type="web3/image/png">

  <link rel="stylesheet" href="web3/vendors/bootstrap/bootstrap.min.css">
  <link rel="stylesheet" href="web3/vendors/fontawesome/css/all.min.css">
  <link rel="stylesheet" href="web3/vendors/themify-icons/themify-icons.css">
  <link rel="stylesheet" href="web3/vendors/linericon/style.css">
  <link rel="stylesheet" href="web3/vendors/owl-carousel/owl.theme.default.min.css">
  <link rel="stylesheet" href="web3/vendors/owl-carousel/owl.carousel.min.css">

  <link rel="stylesheet" href="web3/css/style.css">
</head>
<body>
  <!--================Header Menu Area =================-->
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          ...
          <a class="navbar-brand logo_h" href="index.html"><img src="web3/img/logo.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              ...
              <li class="nav-item"><a class="nav-link" href="Hakkimda.Aspx">HAKKIMIZDA</a></li> 
              <li class="nav-item"><a class="nav-link" href="iletisim.Aspx">İLETİŞİM</a>
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false">GİRİŞ YAP</a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="KullaniciLogin.Aspx">ÜYE GİRİŞİ</a></li>
                  <li class="nav-item"><a class="nav-link" href="Login.Aspx">ADMİN GİRİŞİ</a></li>
                </ul>
							</li>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-banner__img">
              <img class="img-fluid" src="web3/img/banner/hero-banner.png" alt="">
            </div>
          </div>
        ...
        <div class="row no-gutters align-items-center">
          ...
          <div class="col-md-7">
            <div class="about__img">
              <img class="img-fluid" src="web3/img/home/about.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="offer-single__img">
              <img class="img-fluid" src="web3/img/home/offer.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center pt-xl-3 pb-xl-5">
          <div class="col-lg-6">
            <div class="solution__img text-center text-lg-left mb-4 mb-lg-0">
              <img class="img-fluid" src="web3/img/home/solution.png" alt="">
            </div>
          </div>
          <div class="col-lg-6">
        ...
        <div class="owl-carousel owl-theme testimonial">
          <div class="testimonial__item text-center">
            <div class="testimonial__img">
              <img src="web3/img/testimonial/testimonial1.png" alt="">
            </div>
    ...
    <section class="clients_logo_area section-padding">
      <div class="container">
        <div class="clients_slider owl-carousel">
          <div class="item">
            <img src="web3/img/clients-logo/c-logo-1.png" alt="">
          </div>
          <div class="item">
            <img src="web3/img/clients-logo/c-logo-2.png" alt="">
          </div>
          <div class="item">
            <img src="web3/img/clients-logo/c-logo-3.png" alt="">
          </div>
          <div class="item">
            <img src="web3/img/clients-logo/c-logo-4.png" alt="">
          </div>
          <div class="item">
            <img src="web3/img/clients-logo/c-logo-5.png" alt="">
          </div>
        </div>
      </div>
    </section>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <script src="web3/vendors/jquery/jquery-3.2.1.min.js"></script>
  <script src="web3/vendors/bootstrap/bootstrap.bundle.min.js"></script>
  <script src="web3/vendors/owl-carousel/owl.carousel.min.js"></script>
  <script src="web3/js/jquery.ajaxchimp.min.js"></script>
  <script src="web3/js/mail-script.js"></script>
